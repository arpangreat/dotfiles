...
const char *spcmd2[] = {"kitty", "--class", "calc", "-e", "ipython", NULL};
const char *spcmd3[] = {"kitty", "--class", "files", "-e", "ranger", NULL};
const char *spcmd4[] = {"kitty", "--class", "btm", "-e", "btm --battery", NULL};
...
static const Rule rules[] = {
        ...
        {"kitty", "kitty", "~/", 1 << 0, 0, -1},
        {"Thunar", "thunar", "/home/arpangreat/", 1 << 1, 0, -1},
        {"Brave-browser", "brave-browser", "New Tab - Brave", 1 << 2, 0, -1},
};
