...
_G.packer_plugins = {
  ...
  ["alpha-nvim"] = {
    ...
    loaded = true,
    path = "/home/arpangreat/.local/share/nvim/site/pack/packer/start/alpha-nvim",
  ...
  ["noice.nvim"] = {
    loaded = true,
    path = "/home/arpangreat/.local/share/nvim/site/pack/packer/start/noice.nvim",
  ...
  ["nvim-lsp-installer"] = {
    loaded = true,
    path = "/home/arpangreat/.local/share/nvim/site/pack/packer/start/nvim-lsp-installer",
